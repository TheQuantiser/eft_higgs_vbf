...
options.register('gridpackDir',  'root://cmseos.fnal.gov//store/user/jennetd/vbf-eft/gridpacks/', VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack directory?")
options.register('gridpack',  'VBF_SMEFTsim_topU3l_NP1_el9_amd64_gcc11_CMSSW_13_2_9_tarball.tar.xz',  VarParsing.VarParsing.multiplicity.singleton, VarParsing.VarParsing.varType.string,  "Which Gridpack?")
...
options.maxEvents=5000 # maxEvents is a registered option.                                                  
...
# with command line options: Configuration/GenProduction/python/BTV-Run3Summer22EEwmLHEGS-00001-fragment.py --customise Configuration/DataProcessing/Utils.addMonitoring --conditions 124X_mcRun3_2022_realistic_postEE_v1 --beamspot Realistic25ns13p6TeVEarly2022Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=23456 --step LHE,GEN,NANOGEN --geometry DB:Extended --era Run3 --python_filename configuration.py --fileout file:nano_000001.root --number 100 --number_out 100 --no_exec --mc
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/BTV-Run3Summer22EEwmLHEGS-00001-fragment.py nevts:5000'),
...
process.NANOAODGENoutput = cms.OutputModule("NanoAODOutputModule",
    ...
    fileName = cms.untracked.string('file:start0_031726.root'),
...
process.externalLHEProducer = cms.EDProducer("ExternalLHEProducer",
    args = cms.vstring('/uscms/home/azhou/nobackup/smeft/cmseft/generation/genproductions/bin/MadGraph5_aMCatNLO/VBF_SMEFTsim_topU3l_NP1_el9_amd64_gcc11_CMSSW_13_2_9_tarball.tar.xz'),
...
process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=23456
